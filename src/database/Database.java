...
public interface Database {
    ...
    public void removePost(String username, int postID) throws ResourceNotFoundException;
    ...
    public HashSet<User> getUsersFromTagname(String tag);
    public void addFollowerTo(String username, String string) throws ResourceNotFoundException, ForbiddenActionException;
    public void removeFollowerTo(String username, String userToFollow) throws ResourceNotFoundException, ForbiddenActionException;
